...
describe('Start Single DSC accepted', () => {
  ...
  describe('G. Alice starts challenge process T15', () => {
    require('../work-actions/start-dsc-challenge-fulfilled-agreed')(ctx, 'Carol', 'Alice', 'Receipt_1', '2000.0', 'T15');
  });

  describe('H. Alice settles T15', () => {
    require('../work-actions/dsc-settle-qualified')(ctx, 'Alice', 'Receipt_1', '2000.0', 'T15');
  });

  describe('I. Alice withdraws T15', () => {
    require('../work-actions/withdraw-qualified')(ctx, 'Alice', '2000.0', 'T15');
  });
});
