...
describe('Start Single NSC accepted', () => {
  ...
  describe('E. Alice starts challenge process ETH', () => {
    require('../../../../work-actions/nsc/nsc-challenge-qualified')(ctx, 'Carol', 'Alice', '2.0', 'ETH');
  });

  describe('F. Alice settles ETH', () => {
    require('../../../../work-actions/nsc/nsc-settle-qualified')(ctx, 'Alice', '2.0', 'ETH');
  });

  describe('G. Alice withdraws ETH', () => {
    require('../../../..//work-actions/nsc/nsc-withdraw-qualified')(ctx, 'Alice', '2.0', 'ETH');
  });
